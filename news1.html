...
<body>
    <p class="judul">RoboDog Kendali Jarak Jauh, Inovasi ITS bersama Indosat, Nokia, dan NVIDIA</p>

    <p class="publis">Published on<br>Minggu, 1 Maret 2026</p>
    ...
    <p class="agakmasuk">Surabaya, ITS News — <a href="https://www.its.ac.id" target="_blank">Institut Teknologi Sepuluh
            Nopember (ITS)</a> kembali menegaskan kapasitasnya dalam pengembangan robotika dan artificial intelligence
        (AI). Kali ini, ITS bersama Indosat Ooredoo Hutchison (IOH), Nokia, NVIDIA
    ...
    <p id="namareporter"> id Reporter: Naurah Fitri</p>
